...
public class PlayerSource {
    ...
    private boolean adIncoming;
    private Song adBreak;
    private AudioFile lastAudioFile;
    ...
    public PlayerSource(final Enums.PlayerSourceType type, final AudioFile audioFile) {
        ...
        audioFile.addInteraction();
        this.adIncoming = false;
    }
    ...
    /**
     * Schedules an ad to be played after the curr song
     * @param advertisement the ad that will be played
     */
    public void scheduleAd(final Song advertisement) {
        adIncoming = true;
        adBreak = advertisement;
    }
}
