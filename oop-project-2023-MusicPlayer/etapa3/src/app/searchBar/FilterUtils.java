...
public final class FilterUtils {
     ...
     * @return the list
     */
    public static List<Artist> filterArtistByName(final List<Artist> entries,
                                                  final String name) {
        List<Artist> result = new ArrayList<>();
        for (Artist entry : entries) {
            if (entry.getUsername().toLowerCase().startsWith(name.toLowerCase())) {
                result.add(entry);
            }
        }
        return result;
     ...
     * @return the list
     */
    public static List<Host> filterHostByName(final List<Host> entries,
                                              final String name) {
    ...
    public static List<LibraryEntry> filterByDescription(final List<LibraryEntry> entries,
                                                   final String user) {
        return filter(entries, entry -> entry.matchesDescription(user));
    }
